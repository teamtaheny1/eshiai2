...
<?php echo $this->Form->create('Registration', array( 'url'=> array('action' => 'weightIn/' . $event_id )));?>
    <fieldset>
...
<div class="registrations form" id='weighIn'>
    ...
    <tr>
		...
		-->
        <td>
            <?php echo $this->Form->create('Registration', array('url'=> array( 'action' => 'weighIn/' . $event_id )));?>
