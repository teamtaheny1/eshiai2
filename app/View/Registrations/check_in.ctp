...
<?php echo $this->Form->create('Registration', array( 'url'=>array('action' => 'checkIn/' . $event_id )));?>
    <fieldset>
...
<div class="registrations form" id='checkIn' style="width:80%;">
    ...
    <?php foreach( $competitors as $c ): ?>
         <?php 
            echo $this->Form->create('Registration', array( 'url' => array('action' => 'checkIn/' . $event_id )));
